...
export default function UseReducer() {
  ...
  return (
    <GlobalContext.Provider value={{state,dispatch}}>
      <div>
      <UseReducer1 globalContext={GlobalContext}></UseReducer1>
      <UseReducer2 globalContext={GlobalContext}></UseReducer2>
      <UseReducer3 globalContext={GlobalContext}></UseReducer3>
    </div>
